...
Contact.create([
               ...
               {:contactable_id => 2, :first_name => "bharat", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "Transaction ", :company_id => 1},
               ...
               {:contactable_id => 12, :first_name => "bharat", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "Transaction ", :company_id => 1},
               ...
               {:contactable_id => 15, :first_name => "pappu", :middle_name => "bhagvan", :last_name => "kale", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "Transaction ", :company_id => 1},
...
Contact.create([
               ...
               {:contactable_id => 12, :first_name => "Adrian", :middle_name => "Bryan", :last_name => "Payton", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "Transaction ", :company_id => 2},
               ...
               {:contactable_id => 15, :first_name => "William", :middle_name => "Barry", :last_name => "Burton", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "Transaction ", :company_id => 2},
               ...
               {:contactable_id => 18, :first_name => "Eddy", :middle_name => "Joshua", :last_name => "Harryson", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "Transaction ", :company_id => 2},
               ...
               {:contactable_id => 22, :first_name => "Michael", :middle_name => "Daniel", :last_name => "Wilson", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "Transaction ", :company_id => 2},
               ...
               {:contactable_id => 25, :first_name => "Ashley", :middle_name => "William", :last_name => "White", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "Transaction ", :company_id => 2},
               ...
               {:contactable_id => 28, :first_name => "Madison", :middle_name => "Elizabeth", :last_name => "Lewis", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "Transaction ", :company_id => 2},
