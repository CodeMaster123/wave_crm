User.create([
            {:first_name => "Vivek", :last_name => "Varade", :address => "Near Vinchurkar diagnostics, CBS, Nashik", :mobile_no => 9503467486, :email => "superadmin@gmail.com", :password => "superadmin123", :password_confirmation => "superadmin123", :account_type => 1, :company_id => 1},
])
...
CallLog.create([
               {:user_id => 1, :contact_id => 1, :call_result => "Confirm After Second Call", :subject => "Call for Marketing", :call_type => "Outbound", :call_purpose => "Administrative", :call_start_time => "2013-05-20 01:17:00 UTC", :call_duration => 256, :lead_id => 1},
               {:user_id => 1, :contact_id => 2, :call_result => "Requirement for web Site", :subject => "Call for Marketing", :call_type => "Inbound", :call_purpose => "Administrative", :call_start_time => "2013-05-21 02:20:00 UTC", :call_duration => 285, :lead_id => 2},
               {:user_id => 1, :contact_id => 3, :call_result => "Requirement for offline application", :subject => "Call for Marketing", :call_type => "Outbound", :call_purpose => "Administrative", :call_start_time => "2013-05-21 03:17:00 UTC", :call_duration => 500, :lead_id => 3},
               {:user_id => 1, :contact_id => 4, :call_result => "Requirement for web Application", :subject => "Call for Marketing", :call_type => "Inbound", :call_purpose => "Administrative", :call_start_time => "2013-05-21 01:17:00 UTC", :call_duration => 245, :lead_id => 4},
               {:user_id => 1, :contact_id => 5, :call_result => "Second meeting final", :subject => "about second meeting", :call_type => "Outbound", :call_purpose => "Prospective", :call_start_time => "2013-05-25 02:17:00 UTC", :call_duration => 120, :lead_id => 1},
               {:user_id => 1, :contact_id => 6, :call_result => "require demo", :subject => "about demo meeting", :call_type => "Outbound", :call_purpose => "Prospective", :call_start_time => "2013-05-25 03:17:00 UTC", :call_duration => 365, :lead_id => 2},
               {:user_id => 1, :contact_id => 7, :call_result => "Final after second call", :subject => "about second meeting", :call_type => "Inbound", :call_purpose => "Prospective", :call_start_time => "2013-05-26 04:17:00 UTC", :call_duration => 845, :lead_id => 3},
               {:user_id => 1, :contact_id => 8, :call_result => "agree to demo", :subject => "about second meeting", :call_type => "Outbound", :call_purpose => "Prospective", :call_start_time => "2013-05-26 05:17:00 UTC", :call_duration => 652, :lead_id => 4},
               {:user_id => 1, :contact_id => 9, :call_result => "Meeting for demo date final", :subject => "about demo meeting", :call_type => "Outbound", :call_purpose => "Demo", :call_start_time => "2013-05-27 01:17:00 UTC", :call_duration => 325, :lead_id => 1},
               {:user_id => 1, :contact_id => 10, :call_result => "Agree for demo", :subject => "about demo meeting", :call_type => "Inbound", :call_purpose => "Demo", :call_start_time => "2013-05-27 02:17:00 UTC", :call_duration => 635, :lead_id => 2},
               {:user_id => 1, :contact_id => 1, :call_result => "demo date confirm", :subject => "about demo meeting", :call_type => "Outbound", :call_purpose => "Demo", :call_start_time => "2013-05-27 03:17:00 UTC", :call_duration => 452, :lead_id => 3},
               {:user_id => 1, :contact_id => 1, :call_result => "he is agree and final after demo", :subject => "about demo meeting", :call_type => "Inbound", :call_purpose => "Demo", :call_start_time => "2013-05-27 04:17:00 UTC", :call_duration => 675, :lead_id => 4},
               {:user_id => 1, :contact_id => 1, :call_result => "negotiate for payment installment", :subject => "payment negotiation", :call_type => "Outbound", :call_purpose => "Negotiation", :call_start_time => "2013-05-29 01:17:00 UTC", :call_duration => 456, :lead_id => 1},
               {:user_id => 1, :contact_id => 1, :call_result => "negotiate for payment amount", :subject => "payment negotiation", :call_type => "Inbound", :call_purpose => "Negotiation", :call_start_time => "2013-05-29 02:17:00 UTC", :call_duration => 344, :lead_id => 2},
               {:user_id => 1, :contact_id => 1, :call_result => "negotiate for cost of product", :subject => "payment negotiation", :call_type => "Outbound", :call_purpose => "Negotiation", :call_start_time => "2013-05-29 03:17:00 UTC", :call_duration => 333, :lead_id => 3},
               {:user_id => 1, :contact_id => 1, :call_result => "final after negotiation", :subject => "payment negotiation", :call_type => "Inbound", :call_purpose => "Negotiation", :call_start_time => "2013-05-29 04:17:00 UTC", :call_duration => 545, :lead_id => 4},
               {:user_id => 1, :contact_id => 1, :call_result => "delivery time of product final", :subject => "about delivery time", :call_type => "Outbound", :call_purpose => "Support", :call_start_time => "2013-05-30 01:17:00 UTC", :call_duration => 645, :lead_id => 1},
               {:user_id => 1, :contact_id => 1, :call_result => "deliver in next 2 hour", :subject => "about delivery time", :call_type => "Inbound", :call_purpose => "Support", :call_start_time => "2013-05-30 02:17:00 UTC", :call_duration => 543, :lead_id => 2},
               {:user_id => 1, :contact_id => 1, :call_result => "delivery meeting final at 2pm today", :subject => "about delivery time", :call_type => "Outbound", :call_purpose => "Support", :call_start_time => "2013-05-30 03:17:00 UTC", :call_duration => 243, :lead_id => 3},
               {:user_id => 1, :contact_id => 10, :call_result => "delivery meeting final at 2pm next monday", :subject => "about delivery time", :call_type => "Outbound", :call_purpose => "Support", :call_start_time => "2013-05-30 04:17:00 UTC", :call_duration => 467, :lead_id => 4}
])
