...
Event.create([
             ...
             {:contact_id => 1, :title => "ERP to Salim Khan", :starts_at => "2015-04-08 12:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 1, :title => "Meeting", :starts_at => "2015-04-08 06:17:00 UTC", :description => "This meeting for web application demo", :user_id => 1, :company_id => 1},
             {:contact_id => 1, :title => "Meeting", :starts_at => "2015-04-09 12:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 1, :title => "Meeting", :starts_at => "2015-04-10 12:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 2, :title => "Meeting", :starts_at => "2015-04-12 20:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 3, :title => "Meeting", :starts_at => "2015-04-14 12:13:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 4, :title => "Meeting", :starts_at => "2015-04-15 12:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 5, :title => "Meeting with ramesh pawar", :starts_at => "2015-04-16 01:17:00 UTC", :description => "application demo", :user_id => 1, :company_id => 1},
             {:contact_id => 6, :title => "Demo of ERP to Prakash industries", :starts_at => "2015-04-17 12:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 7, :title => "Demo of website to iconic photo studios", :starts_at => "2015-04-18 07:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 7, :title => "ERP to Salim Khan", :starts_at => "2015-04-19 12:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 7, :title => "Meeting", :starts_at => "2015-04-20 06:17:00 UTC", :description => "This meeting for web application demo", :user_id => 1, :company_id => 1},
             {:contact_id => 8, :title => "Meeting", :starts_at => "2015-04-21 12:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 8, :title => "Meeting", :starts_at => "2015-04-22 12:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 8, :title => "Meeting", :starts_at => "2015-04-23 20:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 8, :title => "Meeting", :starts_at => "2015-04-24 12:13:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1},
             {:contact_id => 8, :title => "Meeting", :starts_at => "2015-04-25 12:17:00 UTC", :description => "This meeting for web site demo", :user_id => 1, :company_id => 1}
])
...
Notification.create([
                    {:sms_sent => false, :contact_id => 1, :subject =>"Mail 1", :body => "msg body", :notification_time => "2013-04-05 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 1, :subject =>"Mail 2", :body => "msg body", :notification_time => "2013-04-06 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 2, :subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-07 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 3, :subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-08 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 10, :subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-09 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 8, :subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-10 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 7, :subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-11 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 5, :subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-12 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 9, :subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-13 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 14,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-14 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 11,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-15 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 1,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-16 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 2,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-17 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 13,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-18 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 10,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-19 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 18,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-20 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 17,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-21 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 15,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-22 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 19,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-23 01:17:00 UTC", :company_id => 1},
                    {:sms_sent => false, :contact_id => 14,:subject =>"Mail 3", :body => "msg body", :notification_time => "2013-04-24 01:17:00 UTC", :company_id => 1}
])
...
CallLog.create([
               {:user_id => 1, :contact_id => 1, :call_result => "Confirm After Second Call", :subject => "Call for Marketing", :call_type => "Outbound", :call_purpose => "Administrative", :call_start_time => "2013-05-20 01:17:00 UTC", :call_duration => 256, :call_owner_id => 2, :lead_id => 1},
               {:user_id => 1, :contact_id => 2, :call_result => "Requirement for web Site", :subject => "Call for Marketing", :call_type => "Inbound", :call_purpose => "Administrative", :call_start_time => "2013-05-21 02:20:00 UTC", :call_duration => 285, :call_owner_id => 3, :lead_id => 2},
               {:user_id => 1, :contact_id => 3, :call_result => "Requirement for offline application", :subject => "Call for Marketing", :call_type => "Outbound", :call_purpose => "Administrative", :call_start_time => "2013-05-21 03:17:00 UTC", :call_duration => 500, :call_owner_id => 4, :lead_id => 3},
               {:user_id => 1, :contact_id => 4, :call_result => "Requirement for web Application", :subject => "Call for Marketing", :call_type => "Inbound", :call_purpose => "Administrative", :call_start_time => "2013-05-21 01:17:00 UTC", :call_duration => 245, :call_owner_id => 4, :lead_id => 4},
               {:user_id => 1, :contact_id => 5, :call_result => "Second meeting final", :subject => "about second meeting", :call_type => "Outbound", :call_purpose => "Prospective", :call_start_time => "2013-05-25 02:17:00 UTC", :call_duration => 120, :call_owner_id => 2, :lead_id => 1},
               {:user_id => 1, :contact_id => 6, :call_result => "require demo", :subject => "about demo meeting", :call_type => "Outbound", :call_purpose => "Prospective", :call_start_time => "2013-05-25 03:17:00 UTC", :call_duration => 365, :call_owner_id => 3, :lead_id => 2},
               {:user_id => 1, :contact_id => 7, :call_result => "Final after second call", :subject => "about second meeting", :call_type => "Inbound", :call_purpose => "Prospective", :call_start_time => "2013-05-26 04:17:00 UTC", :call_duration => 845, :call_owner_id => 4, :lead_id => 3},
               {:user_id => 1, :contact_id => 8, :call_result => "agree to demo", :subject => "about second meeting", :call_type => "Outbound", :call_purpose => "Prospective", :call_start_time => "2013-05-26 05:17:00 UTC", :call_duration => 652, :call_owner_id => 4, :lead_id => 4},
               {:user_id => 1, :contact_id => 9, :call_result => "Meeting for demo date final", :subject => "about demo meeting", :call_type => "Outbound", :call_purpose => "Demo", :call_start_time => "2013-05-27 01:17:00 UTC", :call_duration => 325, :call_owner_id => 2, :lead_id => 1},
               {:user_id => 1, :contact_id => 10, :call_result => "Agree for demo", :subject => "about demo meeting", :call_type => "Inbound", :call_purpose => "Demo", :call_start_time => "2013-05-27 02:17:00 UTC", :call_duration => 635, :call_owner_id => 3, :lead_id => 2},
               {:user_id => 1, :contact_id => 1, :call_result => "demo date confirm", :subject => "about demo meeting", :call_type => "Outbound", :call_purpose => "Demo", :call_start_time => "2013-05-27 03:17:00 UTC", :call_duration => 452, :call_owner_id => 4, :lead_id => 3},
               {:user_id => 1, :contact_id => 1, :call_result => "he is agree and final after demo", :subject => "about demo meeting", :call_type => "Inbound", :call_purpose => "Demo", :call_start_time => "2013-05-27 04:17:00 UTC", :call_duration => 675, :call_owner_id => 4, :lead_id => 4},
               {:user_id => 1, :contact_id => 1, :call_result => "negotiate for payment installment", :subject => "payment negotiation", :call_type => "Outbound", :call_purpose => "Negotiation", :call_start_time => "2013-05-29 01:17:00 UTC", :call_duration => 456, :call_owner_id => 2, :lead_id => 1},
               {:user_id => 1, :contact_id => 1, :call_result => "negotiate for payment amount", :subject => "payment negotiation", :call_type => "Inbound", :call_purpose => "Negotiation", :call_start_time => "2013-05-29 02:17:00 UTC", :call_duration => 344, :call_owner_id => 3, :lead_id => 2},
               {:user_id => 1, :contact_id => 1, :call_result => "negotiate for cost of product", :subject => "payment negotiation", :call_type => "Outbound", :call_purpose => "Negotiation", :call_start_time => "2013-05-29 03:17:00 UTC", :call_duration => 333, :call_owner_id => 4, :lead_id => 3},
               {:user_id => 1, :contact_id => 1, :call_result => "final after negotiation", :subject => "payment negotiation", :call_type => "Inbound", :call_purpose => "Negotiation", :call_start_time => "2013-05-29 04:17:00 UTC", :call_duration => 545, :call_owner_id => 4, :lead_id => 4},
               {:user_id => 1, :contact_id => 1, :call_result => "delivery time of product final", :subject => "about delivery time", :call_type => "Outbound", :call_purpose => "Support", :call_start_time => "2013-05-30 01:17:00 UTC", :call_duration => 645, :call_owner_id => 2, :lead_id => 1},
               {:user_id => 1, :contact_id => 1, :call_result => "deliver in next 2 hour", :subject => "about delivery time", :call_type => "Inbound", :call_purpose => "Support", :call_start_time => "2013-05-30 02:17:00 UTC", :call_duration => 543, :call_owner_id => 3, :lead_id => 2},
               {:user_id => 1, :contact_id => 1, :call_result => "delivery meeting final at 2pm today", :subject => "about delivery time", :call_type => "Outbound", :call_purpose => "Support", :call_start_time => "2013-05-30 03:17:00 UTC", :call_duration => 243, :call_owner_id => 4, :lead_id => 3},
               {:user_id => 1, :contact_id => 10, :call_result => "delivery meeting final at 2pm next monday", :subject => "about delivery time", :call_type => "Outbound", :call_purpose => "Support", :call_start_time => "2013-05-30 04:17:00 UTC", :call_duration => 467, :call_owner_id => 4, :lead_id => 4}
])
