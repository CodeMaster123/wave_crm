...
Transaction.create([
                   ...
                   {:amount => 20000, :transaction_time => "2013-05-07 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 2, :matured_by => 4, :executive_type => 1, :transaction_type => "cash", :micr_code => "", :account_id => 2},
                   {:amount => 20000, :transaction_time => "2013-05-08 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 3, :matured_by => 3, :executive_type => 1, :transaction_type => "cash", :micr_code => "", :account_id => 3},
                   {:amount => 20000, :transaction_time => "2013-05-09 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 4, :matured_by => 4, :executive_type => 1, :transaction_type => "cash", :micr_code => "", :account_id => 4},
                   {:amount => 20000, :transaction_time => "2013-05-10 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 5, :matured_by => 5, :executive_type => 2, :transaction_type => "cash", :micr_code => "", :account_id => 5},
                   {:amount => 20000, :transaction_time => "2013-05-11 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 6, :matured_by => 6, :executive_type => 2, :transaction_type => "cash", :micr_code => "", :account_id => 6},
                   {:amount => 20000, :transaction_time => "2013-05-12 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 7, :matured_by => 7, :executive_type => 2, :transaction_type => "cash", :micr_code => "", :account_id => 7},
                   {:amount => 20000, :transaction_time => "2013-05-13 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 8, :matured_by => 8, :executive_type => 2, :transaction_type => "cash", :micr_code => "", :account_id => 8},
                   {:amount => 20000, :transaction_time => "2013-05-14 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 9, :matured_by => 5, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 9},
                   {:amount => 20000, :transaction_time => "2013-05-15 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 10, :matured_by => 6, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 10},
                   {:amount => 20000, :transaction_time => "2013-05-16 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 21, :matured_by => 7, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 1},
                   {:amount => 20000, :transaction_time => "2013-05-17 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 22, :matured_by => 8, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 2},
                   {:amount => 20000, :transaction_time => "2013-05-18 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 23, :matured_by => 5, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 3},
                   {:amount => 20000, :transaction_time => "2013-05-19 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 24, :matured_by => 6, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 4},
                   {:amount => 20000, :transaction_time => "2013-05-20 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 25, :matured_by => 7, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 5},
                   {:amount => 20000, :transaction_time => "2013-05-21 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 26, :matured_by => 8, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 6},
                   {:amount => 20000, :transaction_time => "2013-05-22 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 27, :matured_by => 5, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 7},
                   {:amount => 20000, :transaction_time => "2013-05-23 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 28, :matured_by => 6, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 8},
                   {:amount => 20000, :transaction_time => "2013-05-24 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 29, :matured_by => 7, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 9},
                   {:amount => 20000, :transaction_time => "2013-05-25 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 30, :matured_by => 8, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 10},
                   {:amount => 20000, :transaction_time => "2013-05-01 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 1, :matured_by => 3, :executive_type => 1, :transaction_type => "cash", :micr_code => "", :account_id => 11},
                   {:amount => 20000, :transaction_time => "2013-05-02 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 2, :matured_by => 4, :executive_type => 1, :transaction_type => "cash", :micr_code => "", :account_id => 12},
                   {:amount => 20000, :transaction_time => "2013-05-03 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 3, :matured_by => 3, :executive_type => 1, :transaction_type => "cash", :micr_code => "", :account_id => 13},
                   {:amount => 20000, :transaction_time => "2013-05-04 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 4, :matured_by => 4, :executive_type => 1, :transaction_type => "cash", :micr_code => "", :account_id => 14},
                   {:amount => 20000, :transaction_time => "2013-05-15 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 5, :matured_by => 5, :executive_type => 2, :transaction_type => "cash", :micr_code => "", :account_id => 15},
                   {:amount => 20000, :transaction_time => "2013-05-16 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 6, :matured_by => 6, :executive_type => 2, :transaction_type => "cash", :micr_code => "", :account_id => 16},
                   {:amount => 20000, :transaction_time => "2013-05-17 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 7, :matured_by => 7, :executive_type => 2, :transaction_type => "cash", :micr_code => "", :account_id => 17},
                   {:amount => 20000, :transaction_time => "2013-05-18 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 8, :matured_by => 8, :executive_type => 2, :transaction_type => "cash", :micr_code => "", :account_id => 18},
                   {:amount => 20000, :transaction_time => "2013-05-19 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 9, :matured_by => 5, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 11},
                   {:amount => 20000, :transaction_time => "2013-05-10 01:17:00 UTC", :company_id => 1, :contact_type => 1, :contact_id => 10, :matured_by => 6, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 12},
                   {:amount => 20000, :transaction_time => "2013-05-11 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 21, :matured_by => 7, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 13},
                   {:amount => 20000, :transaction_time => "2013-05-12 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 22, :matured_by => 8, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 14},
                   {:amount => 14000, :transaction_time => "2013-05-13 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 23, :matured_by => 5, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 15},
                   {:amount => 20000, :transaction_time => "2013-05-14 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 24, :matured_by => 6, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 16},
                   {:amount => 20000, :transaction_time => "2013-05-25 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 25, :matured_by => 7, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 17},
                   {:amount => 20000, :transaction_time => "2013-05-26 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 26, :matured_by => 8, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 18},
                   {:amount => 20000, :transaction_time => "2013-05-27 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 27, :matured_by => 5, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 1},
                   {:amount => 20000, :transaction_time => "2013-05-28 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 28, :matured_by => 6, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 12},
                   {:amount => 20000, :transaction_time => "2013-05-29 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 29, :matured_by => 7, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 10},
                   {:amount => 20000, :transaction_time => "2013-05-20 01:17:00 UTC", :company_id => 1, :contact_type => 2, :contact_id => 30, :matured_by => 8, :executive_type => 2, :transaction_type => "cheque", :micr_code => "df565d", :account_id => 14}
                   ])
...
Account.create([
{:is_matured => true, :account_owner => 1, :account_name => "Wave soft pvt ltd", :number_of_employees => 50, :phone_number => 2435684, :website => "www.wavesoft.com", :ownership_type => "proprietership", :billing_address => "CBS, Nasik", :shipping_address => "Ambad, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 3, :account_name => "Chakradhar pvt ltd", :number_of_employees => 96, :phone_number => 2458956, :website => "www.chakradhar.com", :ownership_type => "Private", :billing_address => "Ambad, Nasik", :shipping_address => "Ambad, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 5, :account_name => "Global media pvt ltd", :number_of_employees => 56, :phone_number => 2458457, :website => "www.global.com", :ownership_type => "Public", :billing_address => "College Road, Nasik", :shipping_address => "Satputr, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 7, :account_name => "Pointer pvt ltd", :number_of_employees => 20, :phone_number => 2365241, :website => "www.pointer.com", :ownership_type => "Private", :billing_address => "Nasik Road, Nasik", :shipping_address => "Sinnar, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 8, :account_name => "Creative logics pvt ltd", :number_of_employees => 82, :phone_number => 2859674, :website => "www.creative.com", :ownership_type => "proprietership", :billing_address => "Panchvati, Nasik", :shipping_address => "Satpur, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 10, :account_name => "Mahindra pvt ltd", :number_of_employees => 75, :phone_number => 2568925, :website => "www.mahindra.com", :ownership_type => "Public", :billing_address => "Satputr, Nasik", :shipping_address => "Ambad, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 12, :account_name => "Ceat pvt ltd", :number_of_employees => 35, :phone_number => 2351465, :website => "www.ceat.com", :ownership_type => "proprietership", :billing_address => "CBS, Nasik", :shipping_address => "Sinnar, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 13, :account_name => "Acian pvt ltd", :number_of_employees => 71, :phone_number => 2758545, :website => "www.acian.com", :ownership_type => "Private", :billing_address => "Ambad, Nasik", :shipping_address => "Sinnar, Nasik", :company_id => 1},
{:is_matured => false, :account_owner => 15, :account_name => "Matrix pvt ltd", :number_of_employees => 520, :phone_number => 2124252, :website => "www.matrix.com", :ownership_type => "proprietership", :billing_address => "Dwarka, Nasik", :shipping_address => "Ambad, Nasik", :company_id => 1},
{:is_matured => false, :account_owner => 17, :account_name => "Sun soft pvt ltd", :number_of_employees => 150, :phone_number => 2758412, :website => "www.sunsoft.com", :ownership_type => "Public", :billing_address => "Gangapure road, Nasik", :shipping_address => "Satputr, Nasik", :company_id => 1},
{:is_matured => false, :account_owner => 19, :account_name => "Tech soft pvt ltd", :number_of_employees => 60, :phone_number => 2362541, :website => "www.techsoft.com", :ownership_type => "Private", :billing_address => "Mehar Signal, Nasik", :shipping_address => "Ambad, Nasik", :company_id => 1},
{:is_matured => false, :account_owner => 21, :account_name => "Om Sai pvt ltd", :number_of_employees => 94, :phone_number => 2854785, :website => "www.omsai.com", :ownership_type => "proprietership", :billing_address => "Jail Road, Nasik", :shipping_address => "Sinnar, Nasik", :company_id => 1},
{:is_matured => false, :account_owner => 23, :account_name => "Arres pvt ltd", :number_of_employees => 812, :phone_number => 2968574, :website => "www.arres.com", :ownership_type => "Private", :billing_address => "Nimani, Nasik", :shipping_address => "Sinnar, Nasik", :company_id => 1},
{:is_matured => false, :account_owner => 25, :account_name => "ESDS pvt ltd", :number_of_employees => 254, :phone_number => 2536241, :website => "www.esds.com", :ownership_type => "proprietership", :billing_address => "Satputr, Nasik", :shipping_address => "Satputr, Nasik", :company_id => 1},
{:is_matured => false, :account_owner => 27, :account_name => "Net Win soft pvt ltd", :number_of_employees => 630, :phone_number => 2857496, :website => "www.netwin.com", :ownership_type => "Public", :billing_address => "CBS, Nasik", :shipping_address => "Satputr, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 29, :account_name => "Sai soft pvt ltd", :number_of_employees => 30, :phone_number => 2456585, :website => "www.saisoft.com", :ownership_type => "proprietership", :billing_address => "Shalimar, Nasik", :shipping_address => "Satputr, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 31, :account_name => "Texh Mahindra pvt ltd", :number_of_employees => 59, :phone_number => 2351425, :website => "www.Texh.com", :ownership_type => "Private", :billing_address => "Rane nagar, Nasik", :shipping_address => "Ambad, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 33, :account_name => "Zodac pvt ltd", :number_of_employees => 69, :phone_number => 2758491, :website => "www.zodac.com", :ownership_type => "Private", :billing_address => "Satputr, Nasik", :shipping_address => "Sinnar, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 35, :account_name => "SoftTech pvt ltd", :number_of_employees => 72, :phone_number => 2758496, :website => "www.tofttech.com", :ownership_type => "proprietership", :billing_address => "Cidco, Nasik", :shipping_address => "Ambad, Nasik", :company_id => 1},
{:is_matured => true, :account_owner => 37, :account_name => "MediaTech pvt ltd", :number_of_employees => 900, :phone_number => 2458745, :website => "www.mediaTech.com", :ownership_type => "Public", :billing_address => "CBS, Nasik", :shipping_address => "Sinnar, Nasik", :company_id => 1}
])
