...
Contact.create([
               ...
               {:contactable_id => 2, :first_name => "bharat", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "lead ", :company_id => 1},
               ...
               {:contactable_id => 5, :first_name => "pappu", :middle_name => "bhagvan", :last_name => "kale", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "lead", :company_id => 1},
               ...
               {:contactable_id => 8, :first_name => "bharat", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "lead ", :company_id => 1},
               ...
               {:contactable_id => 12, :first_name => "bharat", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "lead ", :company_id => 1},
               ...
               {:contactable_id => 15, :first_name => "pappu", :middle_name => "bhagvan", :last_name => "kale", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "lead ", :company_id => 1},
               ...
               {:contactable_id => 17, :first_name => "rahul", :middle_name => "suresh", :last_name => "shinde", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "lead", :company_id => 1},
               {:contactable_id => 18, :first_name => "bharat", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "lead ", :company_id => 1},
               {:contactable_id => 19, :first_name => "sagar", :middle_name => "vitthal", :last_name => "kale", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "lead", :company_id => 1},
               ...
               {:contactable_id => 1, :first_name => "sagar", :middle_name => "suresh", :last_name => "shinde", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 2, :first_name => "madhav", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "transaction ", :company_id => 1},
               {:contactable_id => 3, :first_name => "sachin", :middle_name => "vitthal", :last_name => "kale", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 4, :first_name => "madan", :middle_name => "suresh", :last_name => "shinde", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 5, :first_name => "pappu", :middle_name => "bhagvan", :last_name => "kale", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 6, :first_name => "ravi", :middle_name => "bhackar", :last_name => "kale", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 7, :first_name => "sandip", :middle_name => "suresh", :last_name => "shinde", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 8, :first_name => "bharat", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "transaction ", :company_id => 1},
               {:contactable_id => 9, :first_name => "ganesh", :middle_name => "vitthal", :last_name => "kale", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 10, :first_name => "avinash", :middle_name => "suresh", :last_name => "shinde", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 11, :first_name => "sandip", :middle_name => "suresh", :last_name => "shinde", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 12, :first_name => "avin", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "transaction ", :company_id => 1},
               {:contactable_id => 13, :first_name => "sachin", :middle_name => "vitthal", :last_name => "kale", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 14, :first_name => "ganpat", :middle_name => "suresh", :last_name => "shinde", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 15, :first_name => "rohit", :middle_name => "bhagvan", :last_name => "kale", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "transaction ", :company_id => 1},
               {:contactable_id => 16, :first_name => "ravi", :middle_name => "bhackar", :last_name => "kale", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 17, :first_name => "sandip", :middle_name => "suresh", :last_name => "shinde", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 18, :first_name => "bharat", :middle_name => "shivaji", :last_name => "gaikwad", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "transaction ", :company_id => 1},
               {:contactable_id => 19, :first_name => "sachin", :middle_name => "vitthal", :last_name => "kale", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 1},
               {:contactable_id => 20, :first_name => "madan", :middle_name => "suresh", :last_name => "shinde", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "transaction", :company_id => 1}
])
...
Contact.create([
               {:contactable_id => 21, :first_name => "James", :middle_name => "Jack", :last_name => "Pattinson", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 22, :first_name => "Adrian", :middle_name => "Bryan", :last_name => "Payton", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "lead ", :company_id => 2},
               {:contactable_id => 23, :first_name => "Adam", :middle_name => "Patrick", :last_name => "Quincy", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 24, :first_name => "Bryan", :middle_name => "James", :last_name => "Wallace", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 25, :first_name => "William", :middle_name => "Barry", :last_name => "Burton", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "lead ", :company_id => 2},
               {:contactable_id => 26, :first_name => "Edward", :middle_name => "Roger", :last_name => "Hanson", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 27, :first_name => "Johny", :middle_name => "Jacob", :last_name => "Robertson", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 28, :first_name => "Eddy", :middle_name => "Joshua", :last_name => "Harryson", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "lead ", :company_id => 2},
               {:contactable_id => 29, :first_name => "Tyler", :middle_name => "James", :last_name => "Smith", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 30, :first_name => "David", :middle_name => "William", :last_name => "Pattinson", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 31, :first_name => "Jayden", :middle_name => "Christopher", :last_name => "Johnson", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 32, :first_name => "Michael", :middle_name => "Daniel", :last_name => "Wilson", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "lead ", :company_id => 2},
               {:contactable_id => 33, :first_name => "Elijah", :middle_name => "Matthew", :last_name => "Harris", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 34, :first_name => "Noah", :middle_name => "Ethan", :last_name => "Thomas", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 35, :first_name => "Ashley", :middle_name => "William", :last_name => "White", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "lead ", :company_id => 2},
               {:contactable_id => 36, :first_name => "Emily", :middle_name => "Emma", :last_name => "Garcia", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 37, :first_name => "Isabella", :middle_name => "Hannah", :last_name => "Lee", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 38, :first_name => "Madison", :middle_name => "Elizabeth", :last_name => "Lewis", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "lead ", :company_id => 2},
               {:contactable_id => 39, :first_name => "Olivia", :middle_name => "Samantha", :last_name => "Hall", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 40, :first_name => "Abigail", :middle_name => "James", :last_name => "Wright", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "lead", :company_id => 2},
               {:contactable_id => 21, :first_name => "johny", :middle_name => "Jack", :last_name => "Pattinson", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 22, :first_name => "osh", :middle_name => "Bryan", :last_name => "Payton", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "transaction ", :company_id => 2},
               {:contactable_id => 23, :first_name => "mashush", :middle_name => "Patrick", :last_name => "Quincy", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 24, :first_name => "Bryan", :middle_name => "James", :last_name => "Wallace", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 25, :first_name => "William", :middle_name => "Barry", :last_name => "Burton", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "transaction ", :company_id => 2},
               {:contactable_id => 26, :first_name => "Edward", :middle_name => "Roger", :last_name => "Hanson", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 27, :first_name => "Johny", :middle_name => "Jacob", :last_name => "Robertson", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 28, :first_name => "Eddy", :middle_name => "Joshua", :last_name => "Harryson", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "transaction ", :company_id => 2},
               {:contactable_id => 29, :first_name => "Tyler", :middle_name => "James", :last_name => "Smith", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 30, :first_name => "David", :middle_name => "William", :last_name => "Pattinson", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 31, :first_name => "Jayden", :middle_name => "Christopher", :last_name => "Johnson", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 32, :first_name => "Michael", :middle_name => "Daniel", :last_name => "Wilson", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "transaction ", :company_id => 2},
               {:contactable_id => 33, :first_name => "Elijah", :middle_name => "Matthew", :last_name => "Harris", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 34, :first_name => "Noah", :middle_name => "Ethan", :last_name => "Thomas", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 35, :first_name => "Ashley", :middle_name => "William", :last_name => "White", :address => "pune", :mobile_no => 9875942156, :landline_no=> 4584125465, :contactable_type => "transaction ", :company_id => 2},
               {:contactable_id => 36, :first_name => "Emily", :middle_name => "Emma", :last_name => "Garcia", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 37, :first_name => "Isabella", :middle_name => "Hannah", :last_name => "Lee", :address => "lahavit", :mobile_no => 9850753535, :landline_no=> 45852142112, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 38, :first_name => "Madison", :middle_name => "Elizabeth", :last_name => "Lewis", :address => "nasik", :mobile_no => 9154287956, :landline_no=> 4554587111, :contactable_type => "transaction ", :company_id => 2},
               {:contactable_id => 39, :first_name => "Olivia", :middle_name => "Samantha", :last_name => "Hall", :address => "lahavit", :mobile_no => 9812548265, :landline_no=> 48754549555, :contactable_type => "transaction", :company_id => 2},
               {:contactable_id => 40, :first_name => "Abigail", :middle_name => "James", :last_name => "Wright", :address => "lahavit", :mobile_no => 9855849653, :landline_no=> 45854857952, :contactable_type => "transaction", :company_id => 2}
])
